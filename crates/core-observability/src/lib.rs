...
pub use metrics::{
    ...
    record_intent_validation_rejected, record_interruption, record_llm_first_token_latency,
    ...
    record_message_skill, record_mic_to_stt_duration, record_palace_add_memory,

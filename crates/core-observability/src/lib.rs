...
pub use metrics::{
    record_app_switcher_skill, record_backend_audio_chunk, record_backend_audio_finalize,
    ...
    record_backend_udp_discovery_response_total, record_cancellation_success,
    ...
    record_interruption, record_llm_first_token_latency, record_llm_stream_tail_duration,
    record_location_contract, record_location_contract_duration, record_location_preload,
    ...
    record_model_preload, record_model_preload_duration, record_palace_add_memory,
    record_palace_error, record_palace_ingest, record_palace_open, record_palace_search,
    record_palace_wake_up, record_pod_audio_frame, record_pod_connection, record_pod_disconnect,

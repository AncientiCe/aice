...
pub use metrics::{
    ...
    record_message_skill, record_mic_to_stt_duration, record_model_preload,
    record_model_preload_duration, record_palace_add_memory, record_palace_error,
    record_palace_ingest, record_palace_open, record_palace_search, record_palace_wake_up,

...
Use \"intent\": one of \"chat\", \"skill_weather\", \"skill_time\", \"skill_distance\", \"skill_smart_home\", \"skill_assistant\", \"skill_media\", \"skill_memory\", \"skill_computer\". \
...
Assistant: calendar, reminders, messages. Use \"skill_assistant\"; optional \"assistant_kind\": \"calendar\" | \"reminder\" | \"message\". \
...
Examples: {\"intent\": \"skill_weather\"}; {\"intent\": \"skill_smart_home\", \"smart_home_target\": \"living room\", \"smart_home_action\": \"turn off\"}; {\"intent\": \"skill_memory\", \"memory_query\": \"where are keys\", \"memory_store\": false}.";

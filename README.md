...
<details>
<summary>Real-world scenario logs (weather skill turns)</summary>
...
Even with speech/playback included, end-to-end completion in ~6.5-7.3s is very fast for a full local voice turn.
